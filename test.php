...
// TODO: enlever quand fini le projet de recherche
-->
<?php
...
$filmCourant = new Film;
$filmCourant->setTitre('Stalker');
$filmCourant->setRealisateur('Tarkovsky');
$filmCourant->enregistrer();
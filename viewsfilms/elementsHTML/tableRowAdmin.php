...
function tableRow($film)
{
    ...
    <tr>
        ...
        <td>
            <form id="formUpdate" action="/videotheque/viewsfilms/formulaires/formUpdate.php" method="POST">
            ...
            <form id="formEffacer" action="/videotheque/viewsfilms/formulaires/formUpdate.php" method="POST">

...
?>
    ...
    <div class="container">
        <div class="row">
            <h3>Votre panier
                <a class="waves-effect waves-light darken-4 red btn-small marginTop30 right"><i class="material-icons left">delete_forever
        ...
        <table class="centered">
            ...
            <tr>
                ...
                <td>2</td>
                <td>6.99$</td>
                <td><a class="waves-effect waves-light darken-4 red btn-small"><i class="material-icons left">delete</i>Supprimer</a></td>
            </tr>
            <tr>
                <td><img src="/videotheque/images/9a29205e93ecc929871e0b2b53d8ec2491c0a813.jpg" class="imgTable"></td>
                <td>Adaptation</td>
